...
class Cell:
    def __init__(self, label: str | int, html_tag: str, class_name: str, styles: str = "") -> None:
...
class Table:
    def __init__(self, headers: list[Cell], rows: list[list[Cell]], class_name: str, styles: str) -> None:
